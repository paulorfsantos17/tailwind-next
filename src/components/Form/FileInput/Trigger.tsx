  ...
  return (
    <label
      ...
      className={twMerge(
        ...
        'hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-800',
    ...
    >
      ...
      >
        <UploadCloud className="size-5 text-zinc-600 group-hover:text-violet-600 dark:to-zinc-500 dark:group-hover:text-violet-300" />
      </div>
